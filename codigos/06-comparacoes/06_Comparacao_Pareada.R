...
# Read data
data<-read.table("data/soltimes.csv",
                 header=T)
summary(data)

# "Problem" and $Algorithm$ are categorical variable, not a continuous one:
...
t.test(aggdata2$Time.A, aggdata2$Time.B,
       paired=T)
